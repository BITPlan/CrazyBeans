...
public class PetalTreeView {
  ...
  public void showTree(String modelFileName) throws InterruptedException {
    showTree(modelFileName,null);
  }
  
  /**
   * show the tree with an optional path map
   * @param modelFileName
   * @param pathMap
   * @throws InterruptedException 
   */
  public void showTree(String modelFileName,
     PathMap pathMap) throws InterruptedException {
    parser = PetalParser.createParser(modelFileName);
    if (pathMap!=null)
      parser.setPathMap(pathMap);
   ...
   *          - the tree to view
   * @param lock
   *          - the Object to lock with (if any)
   * @throws InterruptedException
   */
  public void showTree(PetalFile tree, Object lock)
      throws InterruptedException {
