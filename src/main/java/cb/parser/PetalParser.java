...
public class PetalParser {
	...
	public PetalParser(Reader r, Map pathMap) {
	...
	public static PetalParser createParser(java.net.URL url, Map pathMap) {
		try {
	...
	public static PetalParser createParser(File file, Map pathMap) {
		try {
	...
	public static PetalParser createParser(Reader stream, Map pathMap) {
